...
describe("Signup for Classes", () => {
  it("Mentor Signup", () => {
    ...
    cy.get(
      ".margin-vertical-3 > .grid-container > .margin-top-3 > h2:first"
  ...
  it("Parent Signup", () => {
    ...
    cy.contains("Log in").click();
    cy.get(".margin-vertical-3 > .grid-container > .margin-top-3 > h2")
      .eq(1)
    ...
    cy.get("body").then(($body) => {
      if ($body.text().includes("Enroll Kelly Doe for the")) {
        cy.get(
          ".margin-vertical-3 > .grid-container > .container > .title"
        ).should(
          "have.text",
          'Enroll Kelly Doe for the "Choose Your Own Adventure" class on Jan. 1, 2022 from 10 a.m. to 1 p.m..'
        );
      } else {
        cy.get(
          ".margin-vertical-3 > .grid-container > .container > .title"
          ...
          "have.text",
          'Kelly Doe can no longer make it to the "Choose Your Own Adventure" class on Jan. 1, 2022 from 10 a.m. to 1 p.m..'
        );
      }
    });
    cy.get("button.button").click();
    cy.get(".padding-vertical-1 > .callout > strong").should(
      "have.text",
      "Well done!"
    );
  });
  ...
  it("Edit student info", () => {
    ...
    cy.contains("Log in").click();
    cy.get(
      ".margin-vertical-3 > .grid-container > .margin-top-3 > .students > tbody > tr:first"
    )
      .contains("Edit Info")
      .click();
