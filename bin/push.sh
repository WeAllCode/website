...
docker tag -f $DOCKER_REPO $DOCKER_USER/$DOCKER_REPO:$CIRCLE_BUILD_NUM
docker push $DOCKER_USER/$DOCKER_REPO:$CIRCLE_BUILD_NUM
docker tag -f $DOCKER_REPO $DOCKER_USER/$DOCKER_REPO:latest
docker push $DOCKER_USER/$DOCKER_REPO:latest

docker tag -f $DOCKER_REPO-static $DOCKER_USER/$DOCKER_REPO-static:$CIRCLE_BUILD_NUM
docker push $DOCKER_USER/$DOCKER_REPO-static:$CIRCLE_BUILD_NUM
docker tag -f $DOCKER_REPO-static $DOCKER_USER/$DOCKER_REPO-static:latest
